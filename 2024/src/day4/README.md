...
Take a look at the little Elf's word search. _How many times does `XMAS` appear_?
...
Flip the word search from the instructions back over to the word search side and try again. _How many times does an `X-MAS` appear_?
